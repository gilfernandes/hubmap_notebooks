...
EXPERIMENT_NAME = '28_pytorch_fpn_efficientnet_b6_1024_2shifted_slices_groupkfold_extra_albu'
...
WD = 1e-3
GRAD_ACCU_STEPS = 1
BEST_MODEL = f'best_model_fpn_1024_double_shift_extra_albu_{ENCODER_NAME}.pth'
